...
*  ![2PC](/assets/distributed_systems/img/2PC.JPG)
...
![Actions by coordinator](/assets/distributed_systems/img/Actions by coordinator.JPG)

### Steps taken by Participant (2PC)

![Actions by participant](/assets/distributed_systems/img/Actions by participant.JPG)

 ### Steps for handling incoming decision requests (2PC)

![Actions for handling decision requests](/assets/distributed_systems/img/Actions for handling decision requests.JPG)
...
* ![3PC](/assets/distributed_systems/img/3PC.JPG)
